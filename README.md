...
```bash
dotnet add package Mailtrap -v 3.2.0 -s github-mailtrap
```

Optionally, you can add the Mailtrap.Abstractions package:

```bash
dotnet add package Mailtrap.Abstractions -v 3.2.0 -s github-mailtrap
```
...
- Email campaigns management (list, create, get, update, delete, and statistics) – [`examples/Mailtrap.Example.EmailCampaigns`](examples/Mailtrap.Example.EmailCampaigns/)
