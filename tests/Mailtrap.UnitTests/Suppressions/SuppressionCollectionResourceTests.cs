...
[TestFixture]
internal sealed class SuppressionCollectionResourceTests
{
    ...
    {
        // Act
        var act = () => new SuppressionCollectionResource(null!, _resourceUri);
    ...
    {
        // Act
        var act = () => new SuppressionCollectionResource(_commandFactoryMock, null!);
    ...
    private SuppressionCollectionResource CreateResource() => new(_commandFactoryMock, _resourceUri);
}
